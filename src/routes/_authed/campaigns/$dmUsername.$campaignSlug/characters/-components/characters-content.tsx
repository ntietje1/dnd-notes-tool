...
export default function CharactersContent() {
  ...
  const characters = useQuery(
    convexQuery(api.characters.queries.getCharactersByCampaign, { campaignId: campaign?._id as Id<"campaigns"> }),
  );
  ...
  if (campaignWithMembership.status === "pending" || characters.status === "pending" || !characters.data) {
