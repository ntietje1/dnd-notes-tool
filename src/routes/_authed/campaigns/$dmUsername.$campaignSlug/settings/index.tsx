  ...
  if (!isDM) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">User Campaign Settings</h2>
  ...
  return (
    <div className="flex-1 p-6 space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-1">Manage your campaign's configuration and preferences.</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Control who can see your campaign</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Let players invite others to join</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Let players create new characters</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-red-700">Hide this campaign from active campaigns</p>
            </div>
